...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        ...
        <li class="breadcrumb-item">@lang('site.sliders')</li>
    </ul>
            ...
            <div class="tile shadow">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-12">
						...
						@endif
                        @if(permissionAdmin('delete-sliders'))
                            <form method="post" action="{{ route('admin.sliders.bulk_delete') }}" style="display: inline-block;">
                                @csrf
                                @method('post')
...
@push('scripts')
    ...
    <script>
        ...
        $(document).on('change', '.status', function (e) {
            ...
            let url    = "{{ route('admin.sliders.status') }}";
            let method = 'post';
            let id     = $(this).data('id');
